...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 09, 2023 at 11:54 AM
...
('2324223', '2', '2', 'L', '2', '22@gmail.com', 2, '2', '1701997944_Picture1.png', 69),
('23244234', 'Mikuuuu', '34223', 'L', '2', '0480@gmail.com', 324, '324', '1701998422_myw.jpg', 70),
('323242', '2', '4322', 'L', '342', '0480@gmail.com', 32, '324', '1701998524_Pic.png', 71),
...
(6, '12349', '2241720148', 2, '', '2023-12-08', 'valid'),
(7, '12345', '2241720148', 2, '', '2023-12-08', 'tidak valid'),
(10, '12345', '2241720148', 2, '', '2023-12-08', 'proses'),
(11, '12345', '2241720148', 2, '1702118936_170.jpg', '2023-12-09', 'proses'),
(12, '12345', '2241720148', 2, '1702119192_170.jpg', '2023-12-09', 'proses');
...
--
ALTER TABLE `pengaduan`
  MODIFY `pengaduan_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `pengaduan`
  ADD CONSTRAINT `pengaduan_ibfk_1` FOREIGN KEY (`nip`) REFERENCES `dosen` (`nip`) ON UPDATE CASCADE,
  ADD CONSTRAINT `pengaduan_ibfk_2` FOREIGN KEY (`nim`) REFERENCES `mahasiswa` (`nim`) ON UPDATE CASCADE,
  ADD CONSTRAINT `pengaduan_ibfk_3` FOREIGN KEY (`pelanggaran_id`) REFERENCES `pelanggaran` (`pelanggaran_id`) ON UPDATE CASCADE;

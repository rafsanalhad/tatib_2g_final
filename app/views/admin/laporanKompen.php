        ...
        <form action="" id="formPelanggaran">
          ...
          <div class="form flex mt-3">
            ...
            <div class="block ml-5">
              ...
              <textarea name="catatan_kompen" class="w-full h-20 p-2 border rounded-md resize-none focus:outline-none focus:border-blue-500 catatanLaporan" placeholder="Isi form jika ingin melakukan penolakan"></textarea>

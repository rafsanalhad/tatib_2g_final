              ...
              <tbody>
                ...
                <tr class="border-b">
                  ...
                  <td class="py-2 px-4 border-r text-center">
                    <!-- proses -->
                    <a href="#"><button class="w-[130px] h-[30px] rounded-md bg-yellow-500 text-lg font-medium text-white">Baru</button></a>
                    <!-- proses diterima -->
                    <a href="#"><button class="w-[130px] h-[30px] rounded-md bg-green-400 text-lg font-medium text-white">Terima</button></a>
                    <!-- proses ditolak -->
                    <a href="#"><button class="w-[130px] h-[30px] rounded-md bg-red-500 text-lg font-medium text-white hover:bg-red-700" onclick="showModalDitolak()">Tolak</button></a>
                  </td>

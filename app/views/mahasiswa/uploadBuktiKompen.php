...
<div class="flex-1 pl-8 pb-8 pt-6 pr-8 shadow-sm main_content text-center ">
    ...
    <form action="<?= BASEURL; ?>/Mahasiswa/updateKompen" method="post" enctype="multipart/form-data" id="formKompen">
        <div class="flex-col bg-white items-center shadow-lg subtitle_dashboard text-center mx-80 shadow-neutral-800">
            ...
            <div class="error_bukti_kompen"></div>
            <br>
...
<script>
$('#formKompen').on('submit', function(e){
    e.preventDefault();
    
    if($('#buktiKompen').val() == ''){
        var flashMessage = '<p class="bg-red-300 ml-2 mr-2">Bukti kompen tidak boleh kosong</p>';

        $('.error_bukti_kompen').html(flashMessage);
    }else{

    ...
    <div class="flex">
        <aside class="p-4 sidebar">
            ...
            <ul>
                ...
                <li class="h-8 flex items-center sidebar_item" id="ubahPassword_mahasiswa"><a href="<?= BASEURL; ?>/mahasiswa/ubahPassword" class="text_sidebar"><img src="<?= BASEURL; ?>/img/icon/ubahPassword.png" class="inline icon_sidebar" alt=""><span class="sidebar_text">Ubah Password</span></a></li>
